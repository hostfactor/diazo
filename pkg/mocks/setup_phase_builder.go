...
type mockConstructorTestingTNewSetupPhaseBuilder interface {
	mock.TestingT
	Cleanup(func())
}

// NewSetupPhaseBuilder creates a new instance of SetupPhaseBuilder. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSetupPhaseBuilder(t mockConstructorTestingTNewSetupPhaseBuilder) *SetupPhaseBuilder {
	mock := &SetupPhaseBuilder{}
	mock.Mock.Test(t)
